...
print('First attempt     {0}'.format(t1.timeit(number = 1000)))
print('First attempt 10x {0}'.format(t1.timeit(number = 10000)))
print()

t2 = Timer('first_unique_char_secondattempt(input_string)',
           'from __main__ import first_unique_char_secondattempt, input_string')
print('Second attempt     {0}'.format(t2.timeit(number = 1000)))
print('Second attempt 10x {0}'.format(t2.timeit(number = 10000)))
print()

t3 = Timer('first_unique_char_thirdattempt(input_string)',
           'from __main__ import first_unique_char_thirdattempt, input_string')
print('Thrid attempt     {0}'.format(t3.timeit(number = 1000)))
print('Thrid attempt 10x {0}'.format(t3.timeit(number = 10000)))
print()
